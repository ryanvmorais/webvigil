...
3. **Checks** (`webvigil.checks`) — plugins `PASSIVE`/`ACTIVE`, registrados por decorator +
   ...
   (HIGH, CWE-97) (spec 013→014): três detectores novos na passada do `InjectionScanner`,
